...
$query = "SELECT * FROM outlet INNER JOIN users ON outlet.id_user = users.id_user";
    ...
    <body>
        ...
        <nav class="navbar static-top">
            <div class="container">
                ...
                <div class="ui secondary pointing menu">
                    ...
                    <center><a class="active item" href="outlet.php">outlet</a></center>
        ...
        <div>
            <div class="container-fluid px-4">
                <div class="container">
                    <div>
                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="crud/add_outlet.php" type="button">add</a>
                    </div>
                </div>
                <br>
                        ...
                        <table class="table table-borderless" border="2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <?= $data['alamat']?> </td>
                                    <td>
                                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="crud/edit_outlet.php?id_outlet=<?=$data['id_outlet']?>" type="button">edit</a>
                                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="../include/process/delete_outlet.php?id_outlet=<?=$data['id_outlet']?>" type="button">delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
