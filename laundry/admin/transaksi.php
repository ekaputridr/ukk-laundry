...
$query = "SELECT * FROM transaksi INNER JOIN member ON transaksi.id_member = member.id_member";
    ...
    <body>
        ...
        <nav class="navbar static-top">
            <div class="container">
                ...
                <div class="ui secondary pointing menu">
                    ...
                    <center><a class="active item" href="transaksi.php">transaksi</a></center>
        ...
        <div>
            <div class="container-fluid px-4">
                <div class="container">
                    <div>
                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="crud/add_transaksi.php" type="button">order</a>
                    </div>
                </div>
                <br>
                        ...
                        <table class="table table-borderless" border="2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="crud/edit_transaksi.php?id_transaksi=<?=$data['id_transaksi']?>" type="button">edit</a>
                                        <a class="btn btn-primary btn-dark btn-sm me-md-2" href="../include/process/delete_transaksi.php?id_transaksi=<?=$data['id_transaksi']?>" type="button">delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
